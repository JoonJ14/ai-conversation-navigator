...
> **SUPERSEDED 2026-07-30** by the root `HANDOFF.md` (v12.2 + v12.3 session). This file remains
> the historical record of the v12.1 arc; for current state, priorities, and risk caveats, the
> root handoff wins.
