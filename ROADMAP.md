...
- Emergent (`app.emergent.sh`) — Emerald theme, ✶ icon, ghost notch — added in v7.1
- Firebase Studio (`studio.firebase.google.com`) — Amber theme, ★ icon, standard button — added in v7.1
